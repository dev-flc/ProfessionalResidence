	...
	<div class="tab-content">
		<!-- inicio escuela -->
  		<div role="tabpanel" class="tab-pane active" id="escuela">
  			...
  			<div class="panel-body">
				{{Form::open(['route'=>['admin.perfil.update',$presidente->id],'method'=>'PUT'])}}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('tel',$presidente->PRE_tel,['class'=>'form-control','required'])!!}
                </div>
                <div class="form-group">
                    {!! Form::label('cel','Celular') !!}
                    {!! Form::text('cel',$presidente->PRE_cel,['class'=>'form-control','required'])!!}
                </div>
