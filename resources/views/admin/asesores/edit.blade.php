	...
	<div class="tab-content">
		<!-- inicio escuela -->
  		<div role="tabpanel" class="tab-pane active" id="escuela">
  			...
  			<div class="panel-body">
				{{Form::open(['route'=>['admin.asesores.update',$asesores->id],'method'=>'PUT'])}}
                <div class="form-group">
                {!! Form::label('nombre','Nombre') !!}
                {!! Form::text('nombre',$asesores->ASE_nombre,['class'=>'form-control','required'])!!}
                </div>
                <div class="form-group">
                    {!! Form::label('apellidop','Apellido Paterno') !!}
                    {!! Form::text('apellidop',$asesores->ASE_apellido_p,['class'=>'form-control','required'])!!}
                </div>

                <div class="form-group">
                    {!! Form::label('apellidom','Apellido Paterno') !!}
                    {!! Form::text('apellidom',$asesores->ASE_apellido_m,['class'=>'form-control','required'])!!}
                </div>
                <div class="form-group">
                    {!! Form::label('tel','Telefono') !!}
                    {!! Form::text('tel',$asesores->ASE_tel,['class'=>'form-control','required'])!!}
                </div>
                <div class="form-group">
                    {!! Form::label('cel','Celular') !!}
                    {!! Form::text('cel',$asesores->ASE_cel,['class'=>'form-control','required'])!!}
                </div>
      ...
      {!! Form::close() !!}
  		...
  		<div role="tabpanel" class="tab-pane" id="director">
  			...
  			<div class="panel-body">
          {{Form::open(['route'=>['admin.asesores.updateuser',$asesores->USU_id],'method'=>'PUT'])}}
                <div class="form-group">
  		...
  		<div role="tabpanel" class="tab-pane" id="direccion">
  			...
  			<div class="panel-body">
				{{Form::open(['route'=>['admin.asesores.updatedirecciones',$asesores->DIR_id],'method'=>'PUT'])}}
                <div class="form-group">
