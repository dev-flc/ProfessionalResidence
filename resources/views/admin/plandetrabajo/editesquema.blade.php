        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-primary">
                  <div class="panel-heading">Nuevo Registrosdsd</div>
                  <div class="panel-body">
                    {{Form::open(['route'=>['admin.plan.upesquema',$seg->id],'method'=>'PUT'])}}

                    <div class="form-group">
                        {!! Form::label('nombre','Nombre') !!}<strong> *</strong>
                        {!! Form::text('nombre',$seg->SEGS_nombre,['class'=>'form-control','required'])!!}
                    </div>
