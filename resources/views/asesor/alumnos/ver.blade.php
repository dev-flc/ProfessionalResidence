		...
		<div class="col-sm-9">
			...
			<div class="container-fluid contenedor">
				<div class="row">
					...
					<br>
						<center><img  src="/files/documentos/book-1.png" alt="...">
						</center>
					</div>
					<div class="col-sm-8 columnas2">
						<h3>
						<center>
						<strong>" {{ $doc->DOC_nombre }} "</strong>
						</center>
						</h3>
						<label>Descripcion:</label> {{ $doc->DOC_descripcion}}
						<p>
						<strong>Fecha:</strong> {{ $doc->DOC_fecha }} | <strong>Fecha y hora de entrega:</strong> {{ $doc->DOC_fecha_entrega }} | {{ $doc->DOC_hora_entrega }} 
						</p>
						<p>
					...
					<div class="col-sm-2 columnas1">
						...
						<img  src="/files/documentos/file.png" alt="...">
			...
			<section class="comments">
			    ...
			    <article class="comment">
			        ...
			        <div class="comment-body">
			            ...
			            <p class="attribution">Comentario por <a href="#">{{ $com->CODO_usuario }}</a> | Fecha y Hora <a href="#">{{ $com->CODO_fecha }}</a></p>
			        </div>
			    </article>
			    @endforeach
			     <article class="comment">
			        <a class="comment-img" href="#non">
			            <button type="button" class="btn btn-info btn-circle btn-lg"><strong>{{ $numcom++ }}</strong></button>
			        </a>  
			        <div class="comment-body">
			            <div class="text">
			            <style type="text/css">
