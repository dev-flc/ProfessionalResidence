        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
              @foreach ($esquema as $segui)

             {{Form::open(['route'=>['alumno.update.updateanteproyecto',$segui->id],'method'=>'PUT','files'=>true])}}
              <div class="form-group">
                {!! Form::label('nombre','nombre') !!}
                {!! Form::text('nombre',$segui->ANT_nombre,['class'=>'form-control inputt','placeholder'=>'nombre'])!!}
              </div>
              
              <div class="form-group">
                {!! Form::label('descripcion','Descripcion') !!}
                {!! Form::textarea('descripcion',$segui->ANT_descripcion,['class'=>'form-control','rows'=>'6','required']) !!}
              </div>
          </div>
