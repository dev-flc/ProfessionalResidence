    ...
    <div class="row">
      ...
      <div class="col-sm-9">  
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              {!! Form::open(['route'=>'alumno.diario.store','method'=>'POST','files'=>'true']) !!}
              <div class="col-sm-6">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      <textarea class="form-control descripcionclass" rows="6" name="descripcion" required></textarea>
                      </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      <textarea class="form-control descripcionn" rows="6" name="des" required></textarea>
                    </div>
                  </div>
