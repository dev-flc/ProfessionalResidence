        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="panel panel-default">
             ...
             {{Form::open(['route'=>['alumno.update.updateensayo',$segui->id],'method'=>'PUT','files'=>true])}}
              <div class="form-group">
                {!! Form::label('nombre','nombre') !!}
                {!! Form::text('nombre',$segui->ESQ_nombre,['class'=>'form-control inputt','placeholder'=>'nombre'])!!}
              </div>
              
              <div class="form-group">
                {!! Form::label('descripcion','Descripcion') !!}
                {!! Form::textarea('descripcion',$segui->ESQ_descripcion,['class'=>'form-control','rows'=>'6','required']) !!}
              </div>
          </div>
